...
const base =
  "mt-1 block w-full min-w-0 box-border appearance-none rounded-md border-2 border-ink/20 bg-background px-3 py-2 text-base text-ink outline-none focus:border-primary";
